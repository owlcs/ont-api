...
public final class TestDataCollection {
    ...
    public static List<Data> getObjects() {
        return Arrays.asList(
                ...
                , new LiteralData() {
                    @Override
                    public OWLLiteral create(OWLDataFactory df) {
                        return df.getOWLLiteral("1998", OWL2Datatype.XSD_POSITIVE_INTEGER);
                    }
                ...
                , new LiteralData() {
                    @Override
                    public OWLLiteral create(OWLDataFactory df) {
                        return df.getOWLLiteral("test", OWL2Datatype.XSD_INT);
                    }
                ...
                , new LiteralData() {
                    @Override
                    public OWLLiteral create(OWLDataFactory df) {
                        return df.getOWLLiteral("-1", df.getOWLDatatype("http://www.w3.org/2001/XMLSchema#short"));
                    }
                ...
                , new AxiomData() {
                    ...
                    public OWLObject create(OWLDataFactory df) {
                        return df.getOWLDataPropertyAssertionAxiom(df.getOWLDataProperty("P"),
                                df.getOWLAnonymousIndividual("_:b12"), df.getOWLLiteral("x", "x"),
                                Collections.singleton(df.getRDFSComment("comm")));
                    }
                ...
                , new AxiomData() {
                    ...
                    @Override
                    public OWLObject create(OWLDataFactory df) {
                        return df.getOWLDisjointClassesAxiom(df.getOWLClass("A"), df.getOWLClass("B"));
                    }
                ...
                , new AxiomData() {
                    ...
                    @Override
                    public OWLObject create(OWLDataFactory df) {
                        return df.getOWLDisjointClassesAxiom(Arrays.asList(
                                df.getOWLObjectHasSelf(df.getOWLObjectProperty("OP")),
                                df.getOWLObjectOneOf(df.getOWLNamedIndividual("I")),
                                df.getOWLDataSomeValuesFrom(df.getOWLDataProperty("DP"), df.getOWLDatatype("D"))),
                                Arrays.asList(df.getRDFSLabel(df.getOWLAnonymousIndividual("_:b0")),
                    ...
                    public String toString() {
                        return "df.getOWLDisjointClassesAxiom(Arrays.asList(" +
                                "df.getOWLObjectHasSelf(df.getOWLObjectProperty(\"OP\")), " +
                                "df.getOWLObjectOneOf(df.getOWLNamedIndividual(\"I\")), " +
                                "df.getOWLDataSomeValuesFrom(df.getOWLDataProperty(\"DP\"), " +
                                "df.getOWLDatatype(\"D\"))), " +
                                "Arrays.asList(df.getRDFSLabel(df.getOWLAnonymousIndividual(\"_:b0\")), " +
                                "df.getOWLAnnotation(df.getOWLBackwardCompatibleWith(), df.getOWLLiteral(2.2))))";
                    }
