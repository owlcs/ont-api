...
public class SubPropertyChainAxiomImpl extends PropertyAxiomImpl implements OWLSubPropertyChainOfAxiom {
     ...
     */
    public SubPropertyChainAxiomImpl(List<? extends OWLObjectPropertyExpression> propertyChain,
                                     OWLObjectPropertyExpression superProperty,
                                     Collection<OWLAnnotation> annotations) {
        super(annotations);
        this.propertyChain = new ArrayList<>(Objects.requireNonNull(propertyChain, "propertyChain cannot be null"));
    ...
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new SubPropertyChainAxiomImpl(getPropertyChain(), getSuperProperty(),
                mergeAnnotations(this, anns));
    }

    @SuppressWarnings("unchecked")
    @Override
    public SubPropertyChainAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
        return new SubPropertyChainAxiomImpl(getPropertyChain(), getSuperProperty(), NO_ANNOTATIONS);
    }
