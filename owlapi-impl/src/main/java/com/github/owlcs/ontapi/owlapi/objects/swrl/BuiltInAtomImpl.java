...
public class BuiltInAtomImpl extends AtomImpl implements SWRLBuiltInAtom {
     ...
     */
    public BuiltInAtomImpl(IRI predicate, List<SWRLDArgument> args) {
        super(predicate);
        this.args = List.copyOf(Objects.requireNonNull(args, "args cannot be null"));
