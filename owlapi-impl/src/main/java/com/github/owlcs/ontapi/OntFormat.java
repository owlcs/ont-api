 ...
 * Jena's formats are located inside <a href="https://github.com/apache/jena/tree/master/jena-arq">jena-arq</a> and
...
public enum OntFormat {
    ...
    public boolean isWriteSupported() {
        return jenaLangs().anyMatch(RDFWriterRegistry::contains) ||
                owlLangs().anyMatch(OWLLang::isWritable);
    }
    ...
    /**
     * Answers {@code true} if it is an XML format.
