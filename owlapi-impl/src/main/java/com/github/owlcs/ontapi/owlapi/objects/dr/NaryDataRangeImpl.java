...
public abstract class NaryDataRangeImpl extends AnonymousDataRangeImpl implements OWLNaryDataRange {

    protected final List<OWLDataRange> operands;

    protected NaryDataRangeImpl(Collection<? extends OWLDataRange> operands) {
