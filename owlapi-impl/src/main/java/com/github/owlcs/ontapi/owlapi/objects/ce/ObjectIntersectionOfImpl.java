...
public class ObjectIntersectionOfImpl extends NaryBooleanClassExpressionImpl implements OWLObjectIntersectionOf {

    /**
     * @param operands a {@code Collection} of {@link OWLClassExpression}ss
     */
    public ObjectIntersectionOfImpl(Collection<? extends OWLClassExpression> operands) {
        super(operands);
    }
    ...
    public Stream<OWLClassExpression> conjunctSet() {
        return forOutput(operands().flatMap(OWLClassExpression::conjunctSet));
    }
