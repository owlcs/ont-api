...
public class DatatypeRestrictionImpl extends AnonymousDataRangeImpl implements OWLDatatypeRestriction {
     ...
     */
    public DatatypeRestrictionImpl(OWLDatatype datatype, Collection<OWLFacetRestriction> restrictions) {
