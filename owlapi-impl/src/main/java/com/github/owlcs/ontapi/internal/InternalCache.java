 ...
 * Currently, it includes only two kind of implementations: an LRU {@code LinkedHashMap} based cache,
 ...
 * This fact allows to make some read operations to be simpler and a little faster,
