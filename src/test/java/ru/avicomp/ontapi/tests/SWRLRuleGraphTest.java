...
public class SWRLRuleGraphTest extends GraphTestBase {
    ...
    public void testRules() throws OWLOntologyCreationException {
        ...
        SWRLAtom atom3 = factory.getSWRLBuiltInAtom(iri.addPath("swrl").addFragment("built-in"), Stream.of(argD1, argD2).collect(Collectors.toList()));
        ...
        List<SWRLAtom> body = Stream.of(atom3, atom4, atom5, atom6, atom7, atom8).collect(Collectors.toList());
