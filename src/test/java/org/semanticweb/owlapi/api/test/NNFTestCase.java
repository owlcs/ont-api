...
public class NNFTestCase {
    ...
    public static Collection<Object[]> getData() {
        ...
        map.put(b.du(), "DisjointUnion(<urn:test#c> <urn:test#c> <urn:test#iri> )");
        ...
        map.put(b.assAnd(), "ClassAssertion(ObjectIntersectionOf(<urn:test#c> <urn:test#iri>) <urn:test#i>)");
        map.put(b.assOr(), "ClassAssertion(ObjectUnionOf(<urn:test#c> <urn:test#iri>) <urn:test#i>)");
        map.put(b.dRangeAnd(),
        ...
        map.put(b.assNot(), "ClassAssertion(ObjectComplementOf(<urn:test#c>) <urn:test#i>)");
        map.put(b.assNotAnon(), "ClassAssertion(ObjectComplementOf(<urn:test#c>) _:id)");
        map.put(b.assSome(), "ClassAssertion(ObjectSomeValuesFrom(<urn:test#op> <urn:test#c>) <urn:test#i>)");
        map.put(b.assAll(), "ClassAssertion(ObjectAllValuesFrom(<urn:test#op> <urn:test#c>) <urn:test#i>)");
        map.put(b.assHas(),
                "ClassAssertion(ObjectSomeValuesFrom(<urn:test#op> ObjectOneOf(<urn:test#i>)) <urn:test#i>)");
        map.put(b.assMin(), "ClassAssertion(ObjectMinCardinality(1 <urn:test#op> <urn:test#c>) <urn:test#i>)");
        map.put(b.assMax(), "ClassAssertion(ObjectMaxCardinality(1 <urn:test#op> <urn:test#c>) <urn:test#i>)");
        map.put(b.assEq(),
        ...
        map.put(b.assHasSelf(), "ClassAssertion(ObjectHasSelf(<urn:test#op>) <urn:test#i>)");
        map.put(b.assOneOf(), "ClassAssertion(ObjectOneOf(<urn:test#i>) <urn:test#i>)");
        map.put(b.assDSome(), "ClassAssertion(DataSomeValuesFrom(<urn:test#dp> <urn:test#datatype>) <urn:test#i>)");
        map.put(b.assDAll(), "ClassAssertion(DataAllValuesFrom(<urn:test#dp> <urn:test#datatype>) <urn:test#i>)");
        map.put(b.assDHas(),
                "ClassAssertion(DataSomeValuesFrom(<urn:test#dp> DataOneOf(\"false\"^^xsd:boolean )) <urn:test#i>)");
        map.put(b.assDMin(), "ClassAssertion(DataMinCardinality(1 <urn:test#dp> <urn:test#datatype>) <urn:test#i>)");
        map.put(b.assDMax(), "ClassAssertion(DataMaxCardinality(1 <urn:test#dp> <urn:test#datatype>) <urn:test#i>)");
        map.put(b.assDEq(),
        ...
        map.put(b.dOneOf(), "DataPropertyRange(<urn:test#dp> DataOneOf(\"false\"^^xsd:boolean ))");
        map.put(b.dNot(), "DataPropertyRange(<urn:test#dp> DataComplementOf(DataOneOf(\"false\"^^xsd:boolean )))");
