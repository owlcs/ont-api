...
public class OWLDataFactoryImplTestCase {
    ...
    public OWLDataFactoryImplTestCase(OWLDataFactory dataFactory) {
        this.dataFactory = dataFactory;
    }

    @Parameterized.Parameters
    public static Collection<OWLDataFactory> parameters() {
        OWLDataFactory noCaching = OWLManager.newOWLDataFactory(false);
        OWLDataFactory withCaching = OWLManager.newOWLDataFactory(true); // was false
