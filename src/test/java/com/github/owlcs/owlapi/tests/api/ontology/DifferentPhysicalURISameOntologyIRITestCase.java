...
public class DifferentPhysicalURISameOntologyIRITestCase extends TestBase {
    ...
    private void differentPhysicalURISameOntologyIRI() throws Exception {
        IRI ontologyADocumentIRI = IRI.create(OWLIOUtils.getResourceURI("/owlapi/" + ONTOLOGY_A));
        IRI ontologyADocumentIRIB = IRI.create(OWLIOUtils.getResourceURI("/owlapi/" + ONTOLOGY_A_EMPTY));
