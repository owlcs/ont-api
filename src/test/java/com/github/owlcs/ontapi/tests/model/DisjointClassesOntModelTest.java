...
public class DisjointClassesOntModelTest extends OntModelTestBase {
    ...
    /**
     * The order while removing (see {@link RDFList#removeList}) is unpredictable.
     * This method checks that that operation does not break the whole process and the ontology data.
     */
    @Test
    ...
    private void testDisjointAddRemove() {
        ...
        IRI fileIRI = IRI.create(OWLIOUtils.getResourceURI("/ontapi/test1.ttl"));
        ...
        OWLIOUtils.print(result.asGraphModel(), OntFormat.TURTLE);
