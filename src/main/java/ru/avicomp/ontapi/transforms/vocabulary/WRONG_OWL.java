 ...
 * Currently only two such cases are found:
 * <ul>
 * <li>owl:propertyChain</li>
 * <li>owl:DataProperty</li>
 * </ul>
 * There are no such URIs in the OWL2 specification. Instead there are following things:
 * <ul>
 * <li>owl:propertyChainAxiom</li>
 * <li>owl:DatatypeProperty</li>
 * </ul>
 * Unfortunately unable to find any documentation about this.
 *
