package ru.avicomp.ontapi.parsers.rdf2axiom;
...
public class ParseHelper {
    ...
    public static ExtendedIterator<OWLAxiom> domainAxioms(Graph graph) {
        graph.find(Node.ANY, RDFS.domain.asNode(), Node.ANY).filterKeep(t -> t.getSubject().isURI());
        //todo:
        return null;
    }
