...
public interface AxiomsSettings {
     ...
     * should retrieved from the {@code Graph}.
     ...
     * turn into OWL Annotations in the composition of nearest declaration axioms.
     * For example, consider the snippet:
     * <pre>{@code
     * <C>  rdf:type      owl:Class ;
     *      rdfs:comment  "comment1"@ex .
     * }</pre>
     * If this option if off, there above RDF corresponds to the axiom
     ...
     * in depends of this parameter bulk annotations fall either into declaration or annotation assertion.
     ...
     * <p>
     * Please note: {@link ru.avicomp.ontapi.jena.impl.conf.OntPersonality.Punnings}
     ...
     * Some of the native OWL-API parsers skips declarations on loading.
     ...
     * A RDF recursion (i.e. {@code <A> rdfs:subClassOf <A>}) is an example of such buggy situation.
     * The default value of this option is {@code false}.
     *
     * @return boolean
