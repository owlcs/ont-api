...
interface HasCardinality {
     ...
     * @see ru.avicomp.ontapi.jena.vocabulary.XSD#nonNegativeInteger
     */
    int getCardinality();
     ...
     * that have fillers which aren't TOP ({@link ru.avicomp.ontapi.jena.vocabulary.OWL#Thing owl:Thing} or
