...
interface CreateSWRL {
     ...
     * that is an URI resource with a type {@link ru.avicomp.ontapi.jena.vocabulary.SWRL#Variable swrl:Variable}.
     *
     ...
     * An input predicate can be taken from {@link ru.avicomp.ontapi.jena.vocabulary.SWRLB SWRL Builins Vocabulary}.
     * Turtle syntax:
     * <pre>{@code
     ...
     * @see ru.avicomp.ontapi.jena.vocabulary.SWRLB
     */
     ...
     * where {@code rdf:type} is {@link ru.avicomp.ontapi.jena.vocabulary.SWRL#AtomList swrl:AtomList}.
     * Turtle syntax:
     * <pre>{@code
