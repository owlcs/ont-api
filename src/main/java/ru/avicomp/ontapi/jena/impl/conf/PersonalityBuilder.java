...
public class PersonalityBuilder {
     ...
     * {@link ru.avicomp.ontapi.jena.impl.PersonalityModel#asPersonalityModel(EnhGraph)} method.
     * For example if you need a check, that some {@link Node node} is an OWL-Class inside your factory,
     * you can use {@link ru.avicomp.ontapi.jena.impl.PersonalityModel#canAs(Class, Node, EnhGraph)}
     * with the type {@link ru.avicomp.ontapi.jena.model.OntClass}.
     *
