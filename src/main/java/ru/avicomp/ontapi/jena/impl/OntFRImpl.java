...
public abstract class OntFRImpl extends OntObjectImpl implements OntFR {
    public static OntObjectFactory lengthFRFactory = new CommonOntObjectFactory(makeMaker(LengthImpl.class), makeFinder(XSD.length), makeFilter(XSD.length));
    public static OntObjectFactory minLengthFRFactory = new CommonOntObjectFactory(makeMaker(MinLengthImpl.class), makeFinder(XSD.minLength), makeFilter(XSD.minLength));
    public static OntObjectFactory maxLengthFRFactory = new CommonOntObjectFactory(makeMaker(MaxLengthImpl.class), makeFinder(XSD.maxLength), makeFilter(XSD.maxLength));
    public static OntObjectFactory minInclusiveFRFactory = new CommonOntObjectFactory(makeMaker(MinInclusiveImpl.class), makeFinder(XSD.minInclusive), makeFilter(XSD.minInclusive));
    public static OntObjectFactory maxInclusiveFRFactory = new CommonOntObjectFactory(makeMaker(MaxInclusiveImpl.class), makeFinder(XSD.maxInclusive), makeFilter(XSD.maxInclusive));
    public static OntObjectFactory minExclusiveFRFactory = new CommonOntObjectFactory(makeMaker(MinExclusiveImpl.class), makeFinder(XSD.minExclusive), makeFilter(XSD.minExclusive));
    public static OntObjectFactory maxExclusiveFRFactory = new CommonOntObjectFactory(makeMaker(MaxExclusiveImpl.class), makeFinder(XSD.maxExclusive), makeFilter(XSD.maxExclusive));
    public static OntObjectFactory totalDigitsFRFactory = new CommonOntObjectFactory(makeMaker(TotalDigitsImpl.class), makeFinder(XSD.totalDigits), makeFilter(XSD.totalDigits));
    public static OntObjectFactory fractionDigitsFRFactory = new CommonOntObjectFactory(makeMaker(FractionDigitsImpl.class), makeFinder(XSD.fractionDigits), makeFilter(XSD.fractionDigits));
    public static OntObjectFactory patternFRFactory = new CommonOntObjectFactory(makeMaker(PatternImpl.class), makeFinder(XSD.pattern), makeFilter(XSD.pattern));
    public static OntObjectFactory langRangeFRFactory = new CommonOntObjectFactory(makeMaker(LangRangeImpl.class), makeFinder(XSD.langRange), makeFilter(XSD.langRange));

    public static OntObjectFactory abstractFRFactory = new MultiOntObjectFactory(lengthFRFactory, minLengthFRFactory,
            maxLengthFRFactory, minInclusiveFRFactory, maxInclusiveFRFactory, minExclusiveFRFactory, maxExclusiveFRFactory,
    ...
    private static Property predicate(Class<?> view) {
        ...
        throw new OntException("Unsupported facet restriction " + view);
    }
