 ...
 */
package ru.avicomp.ontapi.owlapi.objects.literal;
...
public class OWLLiteralImpl extends OWLObjectImpl implements OWLLiteral {
    ...
    private static final OWLDatatype RDF_PLAIN_LITERAL = new ru.avicomp.ontapi.owlapi.OWL2DatatypeImpl(OWL2Datatype.RDF_PLAIN_LITERAL);
    private static final OWLDatatype RDF_LANG_STRING = new ru.avicomp.ontapi.owlapi.OWL2DatatypeImpl(OWL2Datatype.RDF_LANG_STRING);
    ...
    public boolean parseBoolean() {
        return DataFactoryImpl.asBoolean(literal);
    }
