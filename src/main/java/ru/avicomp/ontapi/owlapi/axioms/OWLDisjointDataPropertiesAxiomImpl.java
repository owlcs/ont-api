...
public class OWLDisjointDataPropertiesAxiomImpl
    ...
    @Override
    public OWLDisjointDataPropertiesAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
    ...
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new OWLDisjointDataPropertiesAxiomImpl(properties, mergeAnnotations(this, anns));
    }
