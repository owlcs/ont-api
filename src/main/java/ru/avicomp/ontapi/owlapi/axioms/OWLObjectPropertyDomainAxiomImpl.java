...
public class OWLObjectPropertyDomainAxiomImpl
        extends OWLPropertyDomainAxiomImpl<OWLObjectPropertyExpression> implements OWLObjectPropertyDomainAxiom {
    ...
    @Override
    public OWLObjectPropertyDomainAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
