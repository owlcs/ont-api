...
public class ReflexiveObjectPropertyTranslator
    ...
    OntModelControls control() {
        return OntModelControls.USE_OWL_PROPERTY_REFLEXIVE_FEATURE;
    }

    @Override
    public ONTObject<OWLReflexiveObjectPropertyAxiom> toAxiomImpl(OntStatement statement,
    ...
    @Override
    public ONTObject<OWLReflexiveObjectPropertyAxiom> toAxiomWrap(OntStatement statement,
        ...
        OWLReflexiveObjectPropertyAxiom res = factory.getOWLDataFactory()
                .getOWLReflexiveObjectPropertyAxiom(p.getOWLObject(), TranslateHelper.toSet(annotations));
        return ONTWrapperImpl.create(res, statement).append(annotations).append(p);
    }

    /**
     * @see com.github.owlcs.ontapi.owlapi.axioms.ReflexiveObjectPropertyAxiomImpl
     */
    public static abstract class AxiomImpl extends ObjectAxiomImpl<OWLReflexiveObjectPropertyAxiom>
        ...
        public static class ComplexImpl extends AxiomImpl implements Complex<ComplexImpl, OWLObjectPropertyExpression> {
            ...
            @Override
            public ONTObject<OWLReflexiveObjectPropertyAxiom> merge(ONTObject<OWLReflexiveObjectPropertyAxiom> other) {
                if (this == other) {
                    return this;
                }
