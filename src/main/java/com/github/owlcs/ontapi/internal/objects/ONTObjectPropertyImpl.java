 ...
 *
 * @see com.github.owlcs.ontapi.owlapi.objects.entity.OWLObjectPropertyImpl
 * @since 2.0.0
 */
public class ONTObjectPropertyImpl extends ONTEntityImpl<OWLObjectProperty> implements OWLObjectProperty {
    ...
    /**
     * Using the {@code factory} finds or creates an {@link OWLObjectProperty} instance.
     *
    ...
    public static ONTObject<OWLObjectProperty> find(String uri,
        ...
        return factory.getProperty(OntApiException.mustNotBeNull(model.get().getObjectProperty(uri)));
    }
