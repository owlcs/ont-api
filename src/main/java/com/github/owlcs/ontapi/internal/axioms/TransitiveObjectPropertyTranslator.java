...
public class TransitiveObjectPropertyTranslator
    ...
    OntModelControls control() {
        return OntModelControls.USE_OWL_PROPERTY_TRANSITIVE_FEATURE;
    }
    ...
    public ONTObject<OWLTransitiveObjectPropertyAxiom> toAxiomWrap(OntStatement statement,
        ...
        OWLTransitiveObjectPropertyAxiom res = factory.getOWLDataFactory()
                .getOWLTransitiveObjectPropertyAxiom(p.getOWLObject(), TranslateHelper.toSet(annotations));
        return ONTWrapperImpl.create(res, statement).append(annotations).append(p);
    }

    /**
     * @see com.github.owlcs.ontapi.owlapi.axioms.TransitiveObjectPropertyAxiomImpl
     */
    public static abstract class AxiomImpl extends ObjectAxiomImpl<OWLTransitiveObjectPropertyAxiom>
        ...
        public static class ComplexImpl extends AxiomImpl implements Complex<ComplexImpl, OWLObjectPropertyExpression> {
            ...
            @Override
            public ONTObject<OWLTransitiveObjectPropertyAxiom> merge(ONTObject<OWLTransitiveObjectPropertyAxiom> other) {
                if (this == other) {
                    return this;
                }
