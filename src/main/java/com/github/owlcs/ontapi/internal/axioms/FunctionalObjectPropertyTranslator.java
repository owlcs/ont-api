...
public class FunctionalObjectPropertyTranslator
    ...
    OntModelControls control() {
        return OntModelControls.USE_OWL_OBJECT_PROPERTY_FUNCTIONAL_FEATURE;
    }
    ...
    public ONTObject<OWLFunctionalObjectPropertyAxiom> toAxiomWrap(OntStatement statement,
        ...
        OWLFunctionalObjectPropertyAxiom res = factory.getOWLDataFactory()
                .getOWLFunctionalObjectPropertyAxiom(p.getOWLObject(), TranslateHelper.toSet(annotations));
        return ONTWrapperImpl.create(res, statement).append(annotations).append(p);
    }

    /**
     * @see com.github.owlcs.ontapi.owlapi.axioms.FunctionalObjectPropertyAxiomImpl
     */
    public static abstract class AxiomImpl extends ObjectAxiomImpl<OWLFunctionalObjectPropertyAxiom>
        ...
        public static class ComplexImpl extends AxiomImpl implements Complex<ComplexImpl, OWLObjectPropertyExpression> {
            ...
            @Override
            public ONTObject<OWLFunctionalObjectPropertyAxiom> merge(ONTObject<OWLFunctionalObjectPropertyAxiom> other) {
                if (this == other) {
                    return this;
                }
