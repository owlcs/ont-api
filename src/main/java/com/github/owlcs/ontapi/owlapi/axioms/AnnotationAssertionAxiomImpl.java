...
public class AnnotationAssertionAxiomImpl extends AxiomImpl implements OWLAnnotationAssertionAxiom {
     ...
     */
    public AnnotationAssertionAxiomImpl(OWLAnnotationSubject subject,
    ...
    @Override
    public AnnotationAssertionAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
        return new AnnotationAssertionAxiomImpl(getSubject(), getProperty(), getValue(), NO_ANNOTATIONS);
    }
    ...
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new AnnotationAssertionAxiomImpl(getSubject(), getProperty(), getValue(),
