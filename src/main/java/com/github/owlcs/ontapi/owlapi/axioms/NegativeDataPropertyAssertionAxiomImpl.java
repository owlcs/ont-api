...
public class NegativeDataPropertyAssertionAxiomImpl
     ...
     * @param object      {@link OWLLiteral}, the object
     * @param annotations a {@code Collection} of {@link OWLAnnotation}s
     */
    public NegativeDataPropertyAssertionAxiomImpl(OWLIndividual subject,
    ...
    public OWLSubClassOfAxiom asOWLSubClassOfAxiom() {
        return new SubClassOfAxiomImpl(new ObjectOneOfImpl(getSubject()),
                new ObjectComplementOfImpl(new DataHasValueImpl(getProperty(), getObject())), NO_ANNOTATIONS);
    }

    @SuppressWarnings("unchecked")
    @Override
    public NegativeDataPropertyAssertionAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
        return new NegativeDataPropertyAssertionAxiomImpl(getSubject(), getProperty(), getObject(), NO_ANNOTATIONS);
    }

    @SuppressWarnings("unchecked")
    @Override
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new NegativeDataPropertyAssertionAxiomImpl(getSubject(), getProperty(), getObject(),
