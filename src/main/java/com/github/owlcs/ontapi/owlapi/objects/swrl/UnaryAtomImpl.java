...
public abstract class UnaryAtomImpl<A extends SWRLArgument> extends AtomImpl implements SWRLUnaryAtom<A> {
     ...
     * @param arg       atom
     */
    protected UnaryAtomImpl(SWRLPredicate predicate, A arg) {
        super(predicate);
