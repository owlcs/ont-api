...
public class ObjectHasSelfImpl extends AnonymousClassExpressionImpl implements OWLObjectHasSelf {
     ...
     */
    public ObjectHasSelfImpl(OWLObjectPropertyExpression property) {
