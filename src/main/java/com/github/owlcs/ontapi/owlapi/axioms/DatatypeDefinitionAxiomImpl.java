...
public class DatatypeDefinitionAxiomImpl extends AxiomImpl implements OWLDatatypeDefinitionAxiom {
     ...
     */
    public DatatypeDefinitionAxiomImpl(OWLDatatype datatype,
    ...
    @Override
    public DatatypeDefinitionAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
        return new DatatypeDefinitionAxiomImpl(getDatatype(), getDataRange(), NO_ANNOTATIONS);
    }

    @SuppressWarnings("unchecked")
    @Override
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new DatatypeDefinitionAxiomImpl(getDatatype(), getDataRange(),
