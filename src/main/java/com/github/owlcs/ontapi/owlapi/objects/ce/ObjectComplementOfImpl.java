...
public class ObjectComplementOfImpl extends AnonymousClassExpressionImpl implements OWLObjectComplementOf {

    protected final OWLClassExpression operand;

    /**
     * @param operand class to complement
     */
    public ObjectComplementOfImpl(OWLClassExpression operand) {
