...
public abstract class PropertyDomainAxiomImpl<P extends OWLPropertyExpression>
        extends UnaryPropertyAxiomImpl<P> implements OWLPropertyDomainAxiom<P> {
     ...
     */
    public PropertyDomainAxiomImpl(P property,
