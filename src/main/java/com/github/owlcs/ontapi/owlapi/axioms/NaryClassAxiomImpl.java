...
public abstract class NaryClassAxiomImpl extends ClassAxiomImpl implements OWLNaryClassAxiom {
     ...
     */
    public NaryClassAxiomImpl(Collection<? extends OWLClassExpression> classes,
