...
public class ObjectPropertyAssertionAxiomImpl
     ...
     */
    public ObjectPropertyAssertionAxiomImpl(OWLIndividual subject,
    ...
    @Override
    public ObjectPropertyAssertionAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
        return new ObjectPropertyAssertionAxiomImpl(getSubject(), getProperty(), getObject(), NO_ANNOTATIONS);
    }

    @Override
    public OWLSubClassOfAxiom asOWLSubClassOfAxiom() {
        return new SubClassOfAxiomImpl(new ObjectOneOfImpl(getSubject()),
                new ObjectHasValueImpl(getProperty(), getObject()), NO_ANNOTATIONS);
    }

    @SuppressWarnings("unchecked")
    @Override
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new ObjectPropertyAssertionAxiomImpl(getSubject(), getProperty(), getObject(), mergeAnnotations(this, anns));
    }
    ...
    public OWLObjectPropertyAssertionAxiom getSimplified() {
        ...
        return new ObjectPropertyAssertionAxiomImpl(getObject(), getProperty().getNamedProperty(), getSubject(), NO_ANNOTATIONS);
    }
