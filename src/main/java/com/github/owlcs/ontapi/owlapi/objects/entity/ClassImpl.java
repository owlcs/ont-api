...
public class ClassImpl extends OWLObjectImpl implements OWLClass, Serializable {
    ...
    public static OWLClass fromResource(Resource r) {
        return new ClassImpl(IRI.create(Objects.requireNonNull(r.getURI(), "Not URI: " + r)));
    }
