...
public abstract class SubPropertyAxiomImpl<P extends OWLPropertyExpression>
        extends PropertyAxiomImpl implements OWLSubPropertyAxiom<P> {
     ...
     */
    public SubPropertyAxiomImpl(P subProperty, P superProperty, Collection<OWLAnnotation> annotations) {
        super(annotations);
