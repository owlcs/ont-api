...
public class AnnotationImpl extends AnnotationImplNotAnnotated {
     ...
     */
    public AnnotationImpl(OWLAnnotationProperty property,
    ...
    public OWLAnnotation getAnnotatedAnnotation(@Nonnull Stream<OWLAnnotation> annotations) {
        return new AnnotationImpl(getProperty(), getValue(), mergeAnnotations(this, annotations));
    }
