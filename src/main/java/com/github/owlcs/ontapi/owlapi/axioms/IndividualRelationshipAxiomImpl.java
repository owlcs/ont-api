...
public abstract class IndividualRelationshipAxiomImpl<P extends OWLPropertyExpression, O extends OWLPropertyAssertionObject>
        extends LogicalAxiomImpl implements OWLPropertyAssertionAxiom<P, O> {
     ...
     */
    public IndividualRelationshipAxiomImpl(OWLIndividual subject,
                                           P property,
                                           O object,
