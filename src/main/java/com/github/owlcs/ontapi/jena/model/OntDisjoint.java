...
public interface OntDisjoint<O extends OntObject> extends OntObject, HasRDFNodeList<O> {
    ...
    interface Individuals extends OntDisjoint<OntIndividual>, SetComponents<OntIndividual, Individuals> {
         ...
         * Since both predicates {@link com.github.owlcs.ontapi.jena.vocabulary.OWL#members owl:members} and
        ...
        /**
         * Lists all members from []-list on predicate {@link com.github.owlcs.ontapi.jena.vocabulary.OWL#members owl:members}
         * with concatenation all members from []-list
         * on predicate {@link com.github.owlcs.ontapi.jena.vocabulary.OWL#distinctMembers owl:distinctMembers}.
         *
