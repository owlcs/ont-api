...
public class ObjectUnionOfImpl extends NaryBooleanClassExpressionImpl implements OWLObjectUnionOf {

    /**
     * @param operands a {@code Collection} of {@link OWLClassExpression}s
     */
    public ObjectUnionOfImpl(Collection<? extends OWLClassExpression> operands) {
        super(operands);
    }
