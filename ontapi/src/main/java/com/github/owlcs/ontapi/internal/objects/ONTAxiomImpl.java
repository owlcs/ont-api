...
public abstract class ONTAxiomImpl<X extends OWLAxiom> extends ONTStatementImpl
    ...
    /**
     * Answers {@code true} iff this triple (SPO) has a URI subject.
     *
     * @return boolean
     */
    ...
    /**
     * Answers {@code true} iff this triple (SPO) has a URI object.
     *
     * @return boolean
     */
     ...
     * @throws ClassCastException if the subject is not a URI Resource
     */
     ...
     *
     * @return String, never {@code null}
     * @throws ClassCastException if the object is not a URI Resource
     */
