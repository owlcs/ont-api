...
public class FacetRestrictionImpl extends OWLObjectImpl implements OWLFacetRestriction {
     ...
     */
    public FacetRestrictionImpl(OWLFacet facet, OWLLiteral facetValue) {
