...
public class SubClassOfAxiomImpl extends ClassAxiomImpl implements OWLSubClassOfAxiom {
     ...
     */
    public SubClassOfAxiomImpl(OWLClassExpression subClass,
    ...
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new SubClassOfAxiomImpl(subClass, superClass, mergeAnnotations(this, anns));
    }

    @SuppressWarnings("unchecked")
    @Override
    public SubClassOfAxiomImpl getAxiomWithoutAnnotations() {
        if (!isAnnotated()) {
            return this;
        }
        return new SubClassOfAxiomImpl(subClass, superClass, NO_ANNOTATIONS);
    }
