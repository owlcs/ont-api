...
public class ObjectPropertyImpl extends OWLObjectImpl implements OWLObjectProperty {
     ...
     */
    public ObjectPropertyImpl(IRI iri) {
    ...
    /**
     * Creates an {@link OWLObjectProperty} instance using the {@link Resource} reference.
     *
     * @param r {@link Resource}, not {@code null}
     * @return {@link OWLObjectProperty}
     * @throws NullPointerException if incorrect input
     */
    public static OWLObjectProperty fromResource(Resource r) {
        return new ObjectPropertyImpl(IRI.create(Objects.requireNonNull(r.getURI(), "Not URI: " + r)));
    }
    ...
    public OWLObjectInverseOf getInverseProperty() {
        return new ObjectInverseOfImpl(this);
    }
}
