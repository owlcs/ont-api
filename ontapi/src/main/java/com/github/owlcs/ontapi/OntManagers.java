...
public class OntManagers implements OWLOntologyManagerFactory {
     ...
     * that includes settings from {@link OntSettings /ontapi.properties},
     ...
     * The returned manager itself and any component (i.e. ontologies) are thread-safe,
     ...
     * This is a back door to manage {@link #get()} method behaviour and should not be used without good reason.
     *
    ...
    /**
     * A profile to provide standard cache-based {@code ONT-API} impls.
     */
