...
public class SubAnnotationPropertyOfAxiomImpl extends AxiomImpl implements OWLSubAnnotationPropertyOfAxiom {

    private final OWLAnnotationProperty subProperty;
    private final OWLAnnotationProperty superProperty;

    /**
     * @param subProperty   {@link OWLAnnotationProperty}, the sub property
     * @param superProperty {@link OWLAnnotationProperty}, the super property
     * @param annotations   a {@code Collection} of {@link OWLAnnotation}s on the axiom
     */
    public SubAnnotationPropertyOfAxiomImpl(OWLAnnotationProperty subProperty,
    ...
    public <T extends OWLAxiom> T getAnnotatedAxiom(@Nonnull Stream<OWLAnnotation> anns) {
        return (T) new SubAnnotationPropertyOfAxiomImpl(getSubProperty(), getSuperProperty(),
    ...
    public SubAnnotationPropertyOfAxiomImpl getAxiomWithoutAnnotations() {
        ...
        return new SubAnnotationPropertyOfAxiomImpl(getSubProperty(), getSuperProperty(), NO_ANNOTATIONS);
    }
