...
public class ClassAtomImpl extends UnaryAtomImpl<SWRLIArgument> implements SWRLClassAtom {

    /**
     * @param predicate predicate
     * @param arg       class argument
     */
    public ClassAtomImpl(OWLClassExpression predicate, SWRLIArgument arg) {
        super(predicate, arg);
    }
