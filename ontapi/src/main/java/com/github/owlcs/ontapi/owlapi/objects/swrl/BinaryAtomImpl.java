...
public abstract class BinaryAtomImpl<A extends SWRLArgument, B extends SWRLArgument>
        extends AtomImpl implements SWRLBinaryAtom<A, B> {

    private final A arg0;
    private final B arg1;

    protected BinaryAtomImpl(SWRLPredicate predicate, A arg0, B arg1) {
        super(predicate);
        this.arg0 = Objects.requireNonNull(arg0, "arg0 cannot be null");
