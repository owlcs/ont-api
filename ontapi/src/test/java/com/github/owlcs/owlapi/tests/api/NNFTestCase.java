...
public class NNFTestCase {
    ...
    public static Collection<Object[]> getData() {
        ...
        map.put(b.dRangeRestrict(),
                "DataPropertyRange(<urn:test#dp> DatatypeRestriction(xsd:double facetRestriction(minExclusive \"5.0\"^^xsd:double) facetRestriction(maxExclusive \"6.0\"^^xsd:double)))");
        map.put(b.assD(),
    ...
    public void testAssertion(OWLAxiom object, String expected) {
        NNF subject = new NNF(OWLManager.getOWLDataFactory());
        String result = object.accept(subject).toString();
