...
/**
 * To test (implicitly) {@link com.github.owlcs.ontapi.internal.DirectObjectMapImpl} for {@link OWLAxiom}.
 * <p>
...
public class ContainsAxiomsNoCacheTest extends ContainsAxiomsTest {
    ...
    @ParameterizedTest
    @EnumSource(value = CommonOntologies.class, names = {"PIZZA", "FAMILY", "CAMERA", "TRAVEL"})
