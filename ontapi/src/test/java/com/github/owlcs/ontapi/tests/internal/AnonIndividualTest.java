...
public class AnonIndividualTest extends ObjectFactoryTestBase {
    ...
    public static List<Data> getData() {
        return TestDataCollection.getObjects().stream().filter(Data::isAnonymousIndividual).collect(Collectors.toList());
    }
    ...
    OWLObject fromModel(Data data) {
        ...
        OWLAnonymousIndividual ont = (OWLAnonymousIndividual) data.create(df);

        Ontology o = m.createOntology();
        o.add(df.getOWLObjectPropertyAssertionAxiom(df.getOWLBottomObjectProperty(), df.getOWLNamedIndividual("I"), ont));
        o.clearCache();
        OWLIOUtils.print(o);
